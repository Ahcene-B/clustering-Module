...
from Module.module_CNet import CNet
...
BETA = CNET_UNIF[NAME]['BETA']
ALPHA = CNET_UNIF[NAME]['CC']
BATCH = int(CNET_UNIF[NAME]['BATCH'])
...
if SAVE:
    FNAME = NAME+'/save/save-cnet-'+ INIT + '.npz'
